  ...
  namespace mp
  {
    ...
    public:
      ...
      template<typename OtherFloatingPointType,
               typename OtherFloatingPointEnableType = typename std::enable_if<std::is_floating_point<OtherFloatingPointType>::value && (sizeof(OtherFloatingPointType) >= sizeof(value_type)), void>::type>
      ...
      else if(my_it_regex_match == my_regexes.cbegin())
      {
        ...
        else
        {
          // Extract the real part of the complex number.
          {
            ...
            my_stringstream << my_mr[static_cast<std::size_t>(UINT8_C(1))] << my_mr[static_cast<std::size_t>(UINT8_C(2))];
          ...
          // Extract the imaginary part of the complex number.
          {
            ...
            my_stringstream << my_mr[static_cast<std::size_t>(UINT8_C(3))] << my_mr[static_cast<std::size_t>(UINT8_C(4))];
    ...
    {
      if     (my_pn <  static_cast<int>(INT8_C(0))) { return  T(1U) / pow(my_z, -my_pn); }
    ...
    public:
      ...
      explicit complex(const IntegralType n) : my_re(n),
                                               my_im(static_cast<unsigned>(UINT8_C(0))) { }
      ...
      complex& operator-=(const complex& my_z)
      {
        if(this == &my_z)
        {
          real(mp_cpp(static_cast<unsigned>(UINT8_C(0))));
    ...
    {
      if     (my_pn <  static_cast<int>(INT8_C(0))) { return  mp_cpp(1U) / pow(my_z, -my_pn); }
